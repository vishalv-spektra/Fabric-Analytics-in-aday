...
1.  Navigieren wir nun zurück zum Fabric-Arbeitsbereich **FAIAD\_\<username\> (1),** den Sie in Übung 2, Aufgabe 8 erstellt haben.
...
5.  Wir möchten die zuvor erstellte Tabelle in Lakehouse erstellen. Navigieren Sie im linken Bereich zu **Lakehouse -\> FAIAD\_\<username\>.**
...
2.  Wählen Sie oben links die Option **Speichern und ausführen (2)** aus. Sobald Sie die Benachrichtigung sehen, dass eine Aktualisierung gestartet wurde, können Sie den Dataflow **(3)** schließen.
    ...
    **Hinweis:** Sie werden zum **Arbeitsbereich FAIAD\_\<username\>** weitergeleitet. Es kann einige Momente dauern, bis die Ausführung des Dataflows abgeschlossen ist.
...
1.  Wir navigieren zurück zum Fabric-Arbeitsbereich **FAIAD\_\<username\> (1)**.
...
3.  Das Dialogfeld „Herstellen einer Verbindung mit dem Datenziel“ wird geöffnet. Wählen Sie im **Dropdown-Menü „Verbindung“** die Option **Lakehouse odl_user\_\<Benutzername\> (keine)** aus.
...
6.  Wir möchten die zuvor erstellte Tabelle in Lakehouse erstellen. Navigieren Sie im linken Bereich zu** Lakehouse -\> FAIAD\_\<username\>.**
...
4.  Wählen Sie oben links die Option **Speichern und ausführen (1)** aus. Sobald Sie die Benachrichtigung sehen, dass eine Aktualisierung gestartet wurde, können Sie den Dataflow **(2)** schließen.
    ...
    Sie werden zum Arbeitsbereich **FAIAD\_\<username\> weitergeleitet**. Es kann einige Momente dauern, bis der Dataflow veröffentlicht wird.
