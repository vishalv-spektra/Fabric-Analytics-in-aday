...
3. Das Dialogfeld „Neu: Pipeline“ wird geöffnet. Geben Sie der Pipeline den Namen **pl_Refresh_People_SharePoint**, und wählen Sie **Erstellen** aus.
...
3. Das Dialogfeld „Neu: Pipeline“ wird geöffnet. Geben Sie der Pipeline den **Namen pl_Refresh_People_SharePoint_Option2 (3),** und wählen Sie **Erstellen (4)** aus.
