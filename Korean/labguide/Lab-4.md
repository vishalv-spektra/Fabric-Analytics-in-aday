...
1. 다시 랩 2, 작업 8에서 만든 Fabric 작업 영역, **FAIAD_<username> (1)**으로 되돌아가 보겠습니다.
...
2. 왼쪽 상단 모서리에서 **저장 후 실행 (2)**을 선택합니다. 새로 고침이 시작되었다는 알림이 표시되면 데이터 흐름 **(3)**을 닫을 수 있습니다.
    ...
    **참고: FAIAD_<username> 작업 영역**으로 되돌아갑니다. 데이터 흐름이 실행을 완료하는 데 잠시 시간이 걸릴 수 있습니다.
...
1. Fabric 작업 영역인 **FAIAD_<username> (1)**로 다시 이동해 보겠습니다.
