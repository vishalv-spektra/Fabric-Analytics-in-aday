...
6. 製品グループとリセラー別に製品の詳細を取得してみましょう。製品グループおよびリセラー会社ごとの売上の横棒グラフのビジュアルから、**Tailspin Toys の Packaging Materials バーのオレンジ色**の部分を右クリックし、ダイアログからドリルスルー -> Product Detail を選択します。
